...
#include "ExperimentsECSNNOffroadCar.h"
#include "ExperimentsECSNNOffroadWheelFront.h"
#include "ExperimentsECSNNOffroadWheelRear.h"
...
AExperimentsECSNNOffroadCar::AExperimentsECSNNOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UExperimentsECSNNOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UExperimentsECSNNOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UExperimentsECSNNOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UExperimentsECSNNOffroadWheelRear::StaticClass();
