...
#include "ExperimentsECSNNPlayerController.generated.h"

class UInputMappingContext;
class AExperimentsECSNNPawn;
class UExperimentsECSNNUI;
 ...
 */
UCLASS(abstract)
class AExperimentsECSNNPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<AExperimentsECSNNPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<AExperimentsECSNNPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UExperimentsECSNNUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UExperimentsECSNNUI> VehicleUI;
